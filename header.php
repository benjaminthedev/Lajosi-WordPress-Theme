...
<link href="<?php echo get_site_url();?>/design-your-own/assets/css/index.css" rel="stylesheet" media="all">
...
">
		...
		<div class="navbar navbar-inverse bs-docs-nav navbar-fixed-top sticky-navigation appear-on-scroll">
			<!-- CONTAINER -->
			<div class="top-bar">
				<div class="container" ><div class="top-topbar"><span style="position: relative;
    top: -6px;">Currency: </span><?php echo do_shortcode('[woocs show_flags=0 txt_type="asc" style=1]'); ?></div><div class="left-topbar">
						<span>ENGINEERED FOR GOLF, MELBOURNE, AUSTRALIA</span>
						<a class="top-bar-email" href="mailto:kari@lajosi.com.au">
							<span class=" fa fa-envelope"></span>
						</a>
					</div><div class="right-topbar">
						<div class="cart_container">  
							<div class="cart_content animated fadeIn"> 
							<a href="<?php echo home_url(); ?>/my-account/" class="login-topbar icon-user" title="My Account "> 
