...
include_once 'inc/Architect.php';
...
function azera_shop_scripts() {
	...
	$css_ver = '1.0.6';
	if(current_user_can('edit_posts')) $css_ver .= '.' . mt_rand(10,99999);
	wp_enqueue_style( 'azera-shop-style', get_stylesheet_uri(), array( 'azera-shop-bootstrap-style' ), $css_ver );
   wp_register_script( 'jQuery-mymin', 'https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js', null, null, false );
   wp_enqueue_script('jQuery');
	wp_enqueue_script( 'azera-shop-bootstrap', azera_shop_get_file( '/js/bootstrap.min.js' ), array(), '3.3.5', false );
...
function mycustom_script_word(){

 wp_enqueue_script('custom.js', get_stylesheet_directory_uri().'/js/themejs.js', false ,'1.0', 'all' );

}
add_action( 'wp_enqueue_scripts', 'mycustom_script_word', 10 );
/**
...
if ( ! function_exists( 'azera_shop_footer_powered_by' ) ) {
	...
	function azera_shop_footer_powered_by() {
		?>
		<div class="powered-by"><p style="color:white;">&copy; Copyright <?php echo bloginfo('name') . ' ' . date('Y'); ?></p>
			<?php
			//printf(
...
/*---------changes on 25-9-2018-------*/
//add_action( 'woocommerce_before_add_to_cart_button', 'bbloomer_show_return_policy', 20 );
				      		...
				      		<div class="panel panel-default">
				               	<div class="panel-heading">
				                    <h4 class="panel-title">
				                        <a data-toggle="collapse" data-parent="#accordion1" href="#collapse1n"><label for="Headweight Selection">Headweight Selection</label>
				                    ...
				                    <div class="panel-body">
				                    	<ul>
					                   		<div class="wrapper-swatches">
					                            <li class="radio-custom variable-item button-variable-item">  
					                                <input type="radio" name="headweight" value="345g" id = "variant_1">
					                            </li>
					                            <label for="variant_1">
					                                                345g
					                            </label>
					                 		...
					                 		<div class="wrapper-swatches">
					                            <li class="radio-custom variable-item button-variable-item">  
					                                <input type="radio" name="headweight" value="355g" id = "variant_2">
					                            </li>
					                            <label for="variant_2">
					                                                355g
					                            </label>
					                 		...
					                 		<div class="wrapper-swatches">
					                            <li class="radio-custom variable-item button-variable-item">  
					                                <input type="radio" name="headweight" value="365g" id = "variant_3">
					                            </li>
					                            <label for="variant_3">
					                                                365g
					                            </label>
					                 		...
					                 		<div class="wrapper-swatches">
					                            <li class="radio-custom variable-item button-variable-item">  
					                                <input type="radio" name="headweight" value="375g" id = "variant_4">
					                            </li>
					                            <label for="variant_4">
					                                                375g
					                            </label>
					                 		</div>
					                 		<div class="wrapper-swatches input-custom-wrapper">
					                 			<span>
						                            <li class="radio-custom variable-item button-variable-item">  	<input type="radio" name="">
						                            </li>
					                        	<span>
					                        	<div>
						                            <label >
						                            	<span>
						                            		<input id="input-custom" type="text" name="headweighttext" value=" ">
						                            	</span>
						                            	<span class="input-custom-label">other, specify</span>
						                            </label>
					                        	</div>
					                 		</div>
										</ul>
				    ...
				    <tr>
				    	<td>
				            <div class="panel panel-default">
				                <div class="panel-heading">
				                    <h4 class="panel-title">
				                        <a data-toggle="collapse" data-parent="#accordion1" href="#collapse2n"><label for="tester">Lie Angle Selection</label>
				                            <span class="glyphicon glyphicon-chevron-up"></span>
				                        </a>
				                    </h4>
				                </div>
				                <div id="collapse2n" class="panel-collapse collapse">
				                    <div class="panel-body">
				                    	<ul>
					                    	<div class="wrapper-swatches">
					                            <li class="radio-custom variable-item button-variable-item">  
					                                <input type="radio" name="lieangle" value="68" id ="lieangle_1">
					                            </li>
					                            <label for="lieangle_1">
					                                                68
					                            </label>
					                 		</div>
					                     	<div class="wrapper-swatches">
					                                <li class="radio-custom variable-item button-variable-item">  
					                                    <input type="radio" name="lieangle" value="69" id ="lieangle_2">
					                                </li>
					                                <label for="lieangle_2">
					                                                    69
					                                </label>
					                     	</div>
					                     	<div class="wrapper-swatches">
					                                <li class="radio-custom variable-item button-variable-item">  
					                                    <input type="radio" name="lieangle" value="70" id ="lieangle_3">
					                                </li>
					                                <label for="lieangle_3">
					                                                    70
					                                </label>
					                     	</div>
					                     	<div class="wrapper-swatches">
						                            <li class="radio-custom variable-item button-variable-item">  
						                                <input type="radio" name="lieangle" value="71" id ="lieangle_3">
						                            </li>
						                            <label for="lieangle_3">
						                                                71
						                            </label>
					                 		...
					                 		<div class="wrapper-swatches">
						                            <li class="radio-custom variable-item button-variable-item">  
						                                <input type="radio" name="lieangle" value="72" id ="lieangle_4">
						                            </li>
						                            <label for="lieangle_4">
						                                                72
						                            </label>
					                     	</div>
					                     	<div class="wrapper-swatches input-custom-wrapper">
					                        	...
					                        	<div>
						                            <label >
						                            	<span>
						                            		<input id="input-custom" type="text" name="lieangletextt" value=" ">
						                            	</span>
						                            	<span class="input-custom-label">other, specify</span>
						                            </label>
						                        </div>
				    ...
				    <tr>
				    	<td>
				            <div class="panel panel-default">
				                <div class="panel-heading">
				                    <h4 class="panel-title">
				                        <a data-toggle="collapse" data-parent="#accordion1" href="#collapse3n">
				                            
				                            <label for="tester">Loft Angle Selection</label>
				                            <span class="glyphicon glyphicon-chevron-up"></span>
				                        </a>
				                    </h4>
				                </div>
				                <div id="collapse3n" class="panel-collapse collapse">
				                	<div class="panel-body">
				                		<ul>
					                        <div class="wrapper-swatches">
						                        <li class="radio-custom variable-item button-variable-item">  
						                            <input type="radio" name="loftangle" value="2" id ="loftangle_1">
						                        </li>
						                        <label for="loftangle_1">
						                                            2
						                        </label>
					                 		</div>
						                 	<div class="wrapper-swatches">
						                            <li class="radio-custom variable-item button-variable-item">  
						                                <input type="radio" name="loftangle" value="3" id ="loftangle_2">
						                            </li>
						                            <label for="loftangle_2">
						                                                3
						                            </label>
						                 	</div>
						                 	<div class="wrapper-swatches">
						                            <li class="radio-custom variable-item button-variable-item">  
						                                <input type="radio" name="loftangle" value="4" id ="loftangle_3">
						                            </li>
						                            <label for="loftangle_3">
						                                                4
						                            </label>
						                     </div>
						                 	<div class="wrapper-swatches input-custom-wrapper">
					                        	...
					                        	<div>
						                            <label>
						                            	<span>
						                            		<input id="input-custom" type="text" name="loftangletext" value=" ">
						                            	</span>
						                            	<span class="input-custom-label">other, specify</span>
						                            </label>
					                        	</div>
...
function iconic_add_engraving_text_to_cart_item( $cart_item_data, $product_id, $variation_id ) {
    ...
    $loftangle = empty(filter_input( INPUT_POST, 'loftangle' )) ? filter_input( INPUT_POST, 'loftangletext' ) : filter_input( INPUT_POST, 'loftangle' ) ;
    $lieangle = empty(filter_input( INPUT_POST, 'lieangle' )) ? filter_input( INPUT_POST, 'lieangletext' ) : filter_input( INPUT_POST, 'lieangle' ) ;
    $headweight = empty(filter_input( INPUT_POST, 'headweight' )) ? filter_input( INPUT_POST, 'headweighttext' ) : filter_input( INPUT_POST, 'headweight' ) ;
 
    if (!empty( $loftangle ) ) {
        $cart_item_data['loftangle'] = $loftangle;
        //return $cart_item_data;
    }
    if (!empty( $lieangle ) ) {
        $cart_item_data['lieangle'] = $lieangle;
       // return $cart_item_data;
    }
    if (!empty( $headweight ) ) {
        $cart_item_data['headweight'] = $headweight;
        //return $cart_item_data;
    }
    
 
   // $cart_item_data['testing'] = $engraving_text;
...
function iconic_display_engraving_text_cart( $item_data, $cart_item ) {
    if (!empty( $cart_item['loftangle'] ) ) {
        $item_data[] = array(
        'key'     => __( 'Loft Angle', 'here' ),
        'value'   => wc_clean( $cart_item['loftangle'] ),
        'display' => '',
    );
        //return $item_data;
    }
    if (!empty( $cart_item['lieangle'] ) ) {
        $item_data[] = array(
        'key'     => __( 'Lie Angle', 'here' ),
        'value'   => wc_clean( $cart_item['lieangle'] ),
        'display' => '',
    );
    }
    if (!empty( $cart_item['headweight'] ) ) {
        $item_data[] = array(
        'key'     => __( 'Head Weight', 'here' ),
        'value'   => wc_clean( $cart_item['headweight'] ),
        'display' => '',
    );
        //return $item_data;
    }
    ...
    // $item_data[] = array(
    //     'key'     => __( 'Result', 'here' ),
    //     'value'   => wc_clean( $cart_item['testing'] ),
    //     'display' => '',
    // );
...
function iconic_add_engraving_text_to_order_items( $item, $cart_item_key, $values, $order ) {
    ...
    if (!empty( $values['loftangle'] ) ) {
        $item->add_meta_data( __( 'Loft Angle', 'Here' ), $values['loftangle'] );
       // return;
    }
    if (!empty( $values['lieangle'] ) ) {
        $item->add_meta_data( __( 'Lie Angle', 'Here' ), $values['lieangle'] );
       // return;
    }
    if (!empty( $values['headweight'] ) ) {
        $item->add_meta_data( __( 'Head Weight', 'Here' ), $values['headweight'] );
       // return;
    }
 
    //$item->add_meta_data( __( 'Result', 'Here' ), $values['testing'] );
}
 
add_action( 'woocommerce_checkout_create_order_line_item', 'iconic_add_engraving_text_to_order_items', 10, 4 );

function iconic_add_to_cart_item( $cart_item_data, $product_id, $variation_id ) {
    $engraving_text = filter_input( INPUT_POST, 'pdescription' );
    ...
    $cart_item_data['lpdescription'] = $engraving_text;
   
 
    return $cart_item_data;
}
 
add_filter( 'woocommerce_add_cart_item_data', 'iconic_add_to_cart_item', 10, 3 );

function iconic_display_cart_description( $item_data, $cart_item ) {
    if ( empty( $cart_item['lpdescription'] ) ) {
        return $item_data;
    }
    ...
    $item_data[] = array(
        'key'     => __( 'Description', 'iconic' ),
        'value'   => wc_clean( $cart_item['lpdescription'] ),
        'display' => '',
    );
...
add_filter( 'woocommerce_get_item_data', 'iconic_display_cart_description', 10, 2 );

// new price calculation
add_filter('woocommerce_add_cart_item_data','wdm_add_item_data',90,10);
function wdm_add_item_data($cart_item_data, $product_id) {
    $new_value = array();
    $packaging_price = 0;
    if (isset($_POST['extraprice'])) {
        if ($_POST['extraprice'] == 1) {
            $packaging_price = 99;
        }
    }
    $pcost = isset($_POST['pcost']) ? $_POST['pcost'] : 0.0;
    $new_value['_custom_options'] = $pcost + $packaging_price;
...
function arphabet_widgets_init() {
    ...
    register_sidebar( array(
        ...
        'name' => 'Club Customisation Widget',

        'id' => 'club_customisation_wgt',
