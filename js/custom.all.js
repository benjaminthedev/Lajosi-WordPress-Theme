...
( function($) {
 ...
 // JS TO ADD EYE ICON AND TO MAKE PASSWORD VISIBLE FOR ALL PASSWORDS//
 jQuery( document ).ready(
 		function(){
			var input = jQuery('input:password');
			jQuery(input).each(function() {
			 	if(input.attr("type") == "password") {
			 		var txt1='<span  class="toggle-password fa fa-fw fa-eye" style="float: right;position: relative;bottom: 44px;"></span>';
			 		jQuery(this).after(txt1);
			 	}
 			});
